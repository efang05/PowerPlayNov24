...
//    private Servo servo;
    ...
    public RedCapDetector(HardwareMap hardwareMap, String cameraName){
        this.hardwareMap = hardwareMap;
        this.cameraName = cameraName;

        pipeline = new RedCapPipeline();
    }
...
//
        camera.setPipeline(pipeline = new RedCapPipeline());
